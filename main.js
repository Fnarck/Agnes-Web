  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        formSuccess.textContent = '✓ Merci ! Je vous répondrai dans les plus brefs délais.';
      ...
      formSuccess.textContent = "Une erreur s'est produite. Veuillez réessayer ou me contacter par email.";
